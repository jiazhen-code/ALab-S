...
<template>
	<div>
		...
		<div class="sign-up-header" style="background-image: url('static/images/bg-signup.jpg')">
			<div class="content">
		...
		<a-card :bordered="false" class="card-signup header-solid h-full" :bodyStyle="{paddingTop: 0}">
			...
			<div class="sign-up-gateways">
    			<a-button>
					<img src="../../public/static/images/logos/logos-facebook.svg" alt="">
				</a-button>
    			<a-button>
					<img src="../../public/static/images/logos/logo-apple.svg" alt="">
				</a-button>
    			<a-button>
					<img src="../../public/static/images/logos/Google__G__Logo.svg.png" alt="">
				</a-button>
			</div>
