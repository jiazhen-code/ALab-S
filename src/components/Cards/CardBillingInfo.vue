<template>
	...
	<a-card :bordered="false" class="header-solid h-full" :bodyStyle="{paddingTop: 0, paddingBottom: '16px' }">
		<template #title>
			<h6 class="font-semibold m-0">实验内容</h6>
		</template>
		<a-row :gutter="[24, 24]">
			<a-col :span="24">
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="张三" :column="1">
						<a-descriptions-item label="实验名">
							搅拌
						</a-descriptions-item>
						<a-descriptions-item label="实验编号">
							1@1.com
						</a-descriptions-item>
						<a-descriptions-item label="实验介绍">
							FRB1235476
						</a-descriptions-item>
					</a-descriptions>
				</div>
